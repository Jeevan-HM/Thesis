...
class pc_client(object):
    ...
    def th_pd_gen(self):
        ...
        try:
            if self.flag_reset==1:
                ...
                seg_1 = [1,7,9,2,5,0,1,9,4,1,5,0,0]
                seg_2 = [2,1,2,9,5,0,2,9,0,1,2,0,0]
                seg_3 = [2,0,1,1,5,0,9,2,9,1,2,3,0]
                seg_4 = [8,9,2,0,5,0,1,9,3,1,5,0,0]
                seg_5 = [1,8,9,1,5,0,2,9,8,1,5,0,0]
                seg_6 = [2,1,1,9,5,0,1,9,0,1,0,0,0]
                seg_7 = [3,0,2,1,5,0,9,2,8,1,0,9,0]
                seg_8 = [8,9,1,0,5,0,1,9,2,1,0,0,0]
                

                for i in range(len(seg_1)):
                    array = [seg_1[i],seg_2[i],seg_3[i],seg_4[i],seg_5[i],seg_6[i],seg_7[i],seg_8[i]]
                    self.t0_on_trial = time()
                    self.pres_single_step_response((array),3)
    ...
    def th_data_exchange_high(self):# thread config of read data from mocap and send packed msg to record file.
        ...
        #file_name='SISO__step_trial1.txt'
        #file_name = 'ht_cof.txt'
