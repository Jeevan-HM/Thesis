    ...
    def th_pd_gen(self):
        ...
        try:
            if self.flag_reset==1:
                ...
                self.pres_single_step_response((array),5)

                #step signal of 4 psi to segs 1 and 3
                seg_1 = 4
                seg_2 = 4
                seg_3 = 4
                seg_4 = 4
            ...
            try:
                ...
                for i in range(len(self.NArs)):        
                    if i == 7:
                        ...
                        self.pm_array_1[i] = self.ard_socket(4,self.client_sockets[i])
